...
-   `rumqttc` \
     [rumqttc/CHANGELOG.md](./rumqttc/CHANGELOG.md)

-   `rumqttd` \
     [rumqttd/CHANGELOG.md](./rumqttd/CHANGELOG.md)
...
-   Expose prometheus scraping endpoints for router metrics (#522)
...
-   Removed unused dependencies and updated version of some of used libraries to fix dependabot warnings (#475)
...
-   Add the ability to change log levels and filters dynamically at runtime (#499)
...
-   **changed** Disable async link for this release due to compilation error [**breaking**]
...
-   Add mqtt 4 and 5 parsers to benchmarking suite for comparison
