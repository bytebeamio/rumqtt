...
use crate::{valid_filter, valid_topic, AckPromise, Pending, PromiseTx};
...
impl AsyncClient {
        ...
        P: Into<Bytes>,
    {
        ...
        self.request_tx
            .send_async(Pending::new(request, promise_tx))
            .await?;
        ...
        P: Into<Bytes>,
    {
        ...
        self.request_tx
            .try_send(Pending::new(request, promise_tx))?;
...
impl Client {
        ...
        P: Into<Bytes>,
    {
        ...
        self.client.request_tx.send(Pending {
            request,
