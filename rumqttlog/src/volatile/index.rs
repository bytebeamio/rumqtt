...
impl Index {
    ...
    pub fn write(&mut self, id: u16, pos: u64, len: u64) {
        self.ids.push(id);
    ...
    pub fn read(&self, offset: u64) -> io::Result<(u64, u64, u16)> {
    ...
    pub fn readv(&self, offset: u64, target_size: u64) -> io::Result<(u64, u64, Vec<u16>)> {
        let mut count = 0;
