...
pub enum Packet {
    ...
    ConnAck(ConnAck),
    Publish(Publish),
    PublishWithProperties(Publish, Option<PublishProperties>),
    PubAck(PubAck),
    PubAckWithProperties(PubAck, Option<PubAckProperties>),
    PingReq(PingReq),
    PingResp(PingResp),
    Subscribe(Subscribe),
    SubscribeWithProperties(Subscribe, Option<SubscribeProperties>),
    SubAck(SubAck),
    SubAckWithProperties(SubAck, Option<SubAckProperties>),
    PubRec(PubRec),
    PubRecWithProperties(PubRec, Option<PubRecProperties>),
    PubRel(PubRel),
    PubRelWithProperties(PubRel, Option<PubRelProperties>),
    PubComp(PubComp),
    PubCompWithProperties(PubComp, Option<PubCompProperties>),
